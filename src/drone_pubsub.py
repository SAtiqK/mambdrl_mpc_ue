...
class PubSub:
    ...
    def __init__(self, current_x, current_y,current_z, current_roll, current_pitch, current_yaw, current_vel_x, current_vel_y,
                 current_vel_z, current_vel_roll, current_vel_pitch, current_vel_yaw, pub_pose, pub_vel, queue_size):
    ...
    def sub1callback(self, msg):
        ...
        if self.flagstart == True:
            y_f = float(value)
            self.drone_pose.position.x = y_f
            self.flagx = True
    ...
    def sub2callback(self, msg):
        ...
        if self.flagx == True:
            y_f = float(value)
            self.drone_pose.position.y = y_f
            self.flagy = True
            self.flagx = False
        else:
            pass
    ...
    def sub3callback(self, msg):
        ...
        if self.flagy == True:
            y_f = float(value)
            self.drone_pose.position.z = y_f
            self.flagz = True
            self.flagy = False
        else:
            pass
    ...
    def sub4callback(self, msg):
        if self.flagz== True:
            value = msg.data
            y_f = float(value)
            self.drone_pose.orientation.x = y_f
            self.flagz = False
            self.flagroll= True
        else:
            pass
    ...
    def sub5callback(self, msg):
        if self.flagroll == True:
            value = msg.data
            y_f = float(value)
            self.drone_pose.orientation.y = y_f
            self.flagpitch = True
            self.flagroll = False
    ...
    def sub6callback(self, msg):
        ...
        if self.flagpitch == True:
            y_f = float(value)
            self.drone_pose.orientation.z = y_f
            self.flagyaw = True
            self.flagpitch = False
    ...
    def sub7callback(self, msg):
        if self.flagyaw == True:
            value = msg.data
            self.drone_vel.position.x = float(value)
            # print("7")
            self.flagvx = True
            self.flagyaw = False
        else:
    ...
    def sub8callback(self, msg):
        if self.flagvx == True:
            value = msg.data
            self.drone_vel.position.y = float(value)
            # print("8")
            self.flagvy = True
            self.flagvx = False
        else:
    ...
    def sub9callback(self, msg):
        if self.flagvy == True:
            value = msg.data
            self.drone_vel.position.z  = float(value)
            # print("9")
            self.flagvz = True
            self.flagvy = False
        else:
    ...
    def sub10callback(self, msg):
        if self.flagvz == True:
            value = msg.data
            self.drone_vel.orientation.x = float(value)
            # print("10")
            self.flagvroll = True
            self.flagvz = False
        else:
    ...
    def sub11callback(self, msg):
        if self.flagvroll== True:
            value = msg.data
            self.drone_vel.orientation.y = float(value)
            # print("11")
    ...
    def sub12callback(self, msg):
        if self.flagvpitch== True:
            value = msg.data
            self.drone_vel.orientation.z = float(value)
            self.flagvyaw = True
            self.flagvpitch = False
            self.flags_reset()

            self.curr_pose.publish(self.drone_pose)
            self.curr_vel.publish(self.drone_vel)
